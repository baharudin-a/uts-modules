        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Event Masuk</h4>
              <div class="card-body">
...
<!--                 <form action="<?php //base_url('event/add') ?>" method="post" enctype="multipart/form-data" >
 ...
 -->
              ...
              <table class="table table-hover">
               ...
               <tbody>
                  <?php foreach ($event_masuk as $masuk): ?>
                  <tr>
                    <td>
                      <?php echo $masuk->event ?>
                    </td>
                    <td>
                      <?php echo $masuk->keterangan ?>
                    </td>
                    <td>
                      <?php echo $masuk->nominal ?>
                    </td>
                    
                   
                   
                    <td width="250">
                      <a href="<?php echo site_url('admin/edit/'.$masuk->id) ?>"
                       class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                      <a onclick="deleteConfirm('<?php echo site_url('/admin/delete/'.$masuk->id) ?>')"
