...
<html>
   ...
   <body>
            ...
            <div class="nav-wrapper container">
               <ul id="nav-mobile" class="right hide-on-med-and-down">
                  ...
                  <?php } else { ?>
                     ...
                     <li><a href="<?= base_url(); ?>home/loginusr"><i class="fa fa-sign-in"></i> login</a></li>
      ...
      <main>
         <div class="toko">
         	<img width=1080 src="<?= base_url(); ?>assets/upload/banner.jpg">
<!--             <h2><a href="<//?= base_url(); ?>"><i class="fa fa-shopping-cart"></i> OlShopKu</a></h2>
